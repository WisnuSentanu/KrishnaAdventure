...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <title>Transport & Tour Adventure</title>
          ...
          <div class="swiper-slide context-dark" data-slide-bg="assets/images/slider1.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
                  <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100"><span class="font-weight-bold">Transport & Tour</span></h2>
                        ...
                        <div class="unit-body" style="flex-grow: 1; display: flex; flex-direction: column;">
                            <div class="product-big-body">
                                ...
                                <div class="product-big-price-wrap mt-0">
                                  ...
                                  @else
                                      <!-- Jika tidak dalam periode promo, hanya tampilkan harga asli -->
                                      <span class="product-big-price" style="font-size: 1rem; font-weight: bold;">
                                          {{ $kegiatan->harga }} <!-- Tampilkan harga asli -->
                                      </span>
                                  @endif
                              </div>
