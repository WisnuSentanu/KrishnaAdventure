...
<!-- MENU DASHBOARD -->
<li class="nav-item @if($menu == 'Seleksi') menu-open @endif">
            <a href="#" class="nav-link @if($menu == 'Seleksi') active @endif">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>Seleksi<i class="right fas fa-angle-left"></i></p>
            </a>

            <ul class="nav nav-treeview">

              <li class="nav-item">
                <a href="{{url('/')}}" class="nav-link @if($submenu == 'Kelola Seleksi') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kelola Seleksi</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{url('/')}}" class="nav-link @if($submenu == 'Kelola Paket Seleksi') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Paket Seleksi</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{url('/')}}" class="nav-link @if($submenu == 'Kelola Konten Seleksi') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Konten Seleksi</p>
                </a>
              </li>
