          ...
          <div class="swiper-slide context-dark" data-slide-bg="assets/images/slider2.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
                  <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100"><span class="font-weight-bold">Land Adventure</span></h2>
                    <h6 class="text-uppercase" data-caption-animate="fadeInRight" data-caption-delay="0">Here are the tourist attractions in West Bali National Park: trekking, mangrove tours, safari tours, birdwatching, camping, cycling, etc.</h6>
                  </div>
                </div>
              </div>
            </div>
